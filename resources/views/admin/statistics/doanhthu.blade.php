...
@section('content_header')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">Thống kê doanh thu hàng tháng</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="#">Trang chủ</a></li>
                        <li class="breadcrumb-item active">Thống doanh thu hàng tháng</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
    ...
    <div class="col-md-12">
        ...
        <div class="card mb-3">
            <div class="card-header">
                <i class="fa fa-area-chart"></i> Tổng tiền theo các tháng </div>
            <div class="card-body">
...
@section('js')
    ...
    <script src="{{ asset('customer/js/create-charts-doanh-thu.js') }}"></script>
