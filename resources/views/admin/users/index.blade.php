...
@section('content')
    <button type="button" style="margin-bottom: 15px;" class="btn btn-success"><a href="{{ route('users.create') }}" style="color: #ffffff">Thêm mới người dùng</a></button>
    <div class="col-sm-12">
    ...
    <table id="example" class="display nowrap" style="width:100%">
        ...
        @foreach($users as $user)
            <tr>
                ...
                <td>{{ $user->address }}</td>
                <td>
{{--                    <a href="{{ route('users.show',$user->id) }}" style="margin-right: 5px; ">--}}
...
{{--                        <button style="margin-right: 5%; background-color: #0e84b5"><i class="fas fa-edit"></i></button>--}}
                    ...
                    <a href="#" data-href="{{asset('users/delete/'.$user->id)}}" data-toggle="modal" data-target="#confirm-delete">
