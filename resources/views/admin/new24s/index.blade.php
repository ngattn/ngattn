            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Thêm mới danh sách tin tức</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
...
@section('content')
    <button type="button" style="margin-bottom: 15px;" class="btn btn-success">
        <a href="{{ route('newAdd') }}">Thêm mới</a>
    </button>
    <div class="col-sm-12">
...
{{--                    </a>--}}
                    ...
                    <a href="#" data-href="{{asset('news/delete/'.$new->id)}}" data-toggle="modal" data-target="#confirm-delete">
