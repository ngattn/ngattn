...
@section('content_header')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">Thêm mới loại sản phẩm </h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
    ...
    <div class="col-md-12">
        <div class="card card-primary">
            <div class="row container-fluid">
                <div style="width: 50%;font-size: 20px">Thêm mới loại sản phẩm</div>
            ...
            <hr>
            <form method="POST" action="{{ route('type-products.store') }}">
                @csrf
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                          ...
                          <span class="input-group-text">
                            ...
                            <input type="text" class="form-control float-right" id="title" name="txtname" required>
                        </div>
                        <!-- /.input group -->
                    </div>
