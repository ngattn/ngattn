                            ...
                            <div class="col-lg-4 col-md-6">
                                <div class="li-blog-single-item pb-25">
                                    <div class="li-blog-banner">
                                        <a href="dịch-vụ/chi-tiet-dịch-vụ/{{ $service->id }}/{{ $service->slug }}.html" src="{{ asset('uploads/services/'.$service->image) }}" alt=""></a>
                                    </div>
                                    <div class="li-blog-content">
                                        <div class="li-blog-details">
                                            <h3 class="li-blog-heading pt-25"><a href="dịch-vụ/chi-tiet-dịch-vụ/{{ $service->id }}/{{ $service->slug }}.html">{{ $service->title }}</a></h3>
                                            <div class="li-blog-meta">
                                                <a class="author" href="#"><i class="fa fa-user"></i>Admin</a>
                                                <!-- <a class="comment" href="#"><i class="fa fa-comment-o"></i> 3 comment</a> -->
                                                <a class="post-time" href="#"><i class="fa fa-calendar"></i> {{ $service->created_at }}</a>
                                            </div>
