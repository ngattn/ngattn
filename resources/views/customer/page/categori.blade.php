                               ...
                               <!-- Product Details Left -->
                                <div class="product-details-left">
                                    <div class="product-details-images slider-navigation-1">
                                        ...
                                        @foreach($sp->ProductImage as $valu)
                                            <div class="lg-image">
                                                <img src="{{url('uploads/products/image_product/'.$valu->image)}}" alt="product image">
                                            </div>
                                        @endforeach 
                                    </div>
                                    <div class="product-details-thumbs slider-thumbs-1">    
                                        ...
                                        @foreach($sp->ProductImage as $valu)                                    
                                            <div class="sm-image"><img src="{{url('uploads/products/image_product/'.$valu->image)}}" alt="product image thumb"></div>
                                        @endforeach
                                    </div>
                                </div>
                                <!--// Product Details Left -->
